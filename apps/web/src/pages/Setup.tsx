...
import { Terminal, Key, Database, ShieldCheck, ArrowRight, Server } from 'lucide-react';
        ...
        <div className="flex-1 space-y-6 w-full lg:max-w-3xl">
          ...
          <div className="bg-white border border-zinc-200 p-6 flex gap-4 shadow-sm rounded-lg hover:border-emerald-200 transition-colors">
            ...
            <div>
              ...
              <ol className="list-decimal pl-5 text-sm text-zinc-700 space-y-2">
                ...
                <li>Enter a strong <strong>Database Password</strong> (save it to your scratchpad).</li>
                <li>Once the project builds, go to <strong>Project Settings -&gt; General</strong>. Copy your <code>Project ID</code> (e.g. abcdef...) into the Scratchpad.</li>
              </ol>
            </div>
          </div>
          ...
          <div className="bg-white border border-zinc-200 p-6 flex gap-4 shadow-sm rounded-lg hover:border-emerald-200 transition-colors">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-600 mt-1 mb-3">This token allows the CLI wizard to push migrations and edge functions to your database.</p>
              <ol className="list-decimal pl-5 text-sm text-zinc-700 space-y-2">
                <li>Go to your <a href="https://supabase.com/dashboard/account/tokens" target="_blank" rel="noreferrer" className="text-blue-600 hover:underline">Account Access Tokens</a>.</li>
                <li>Click <strong>Generate new token</strong> and give it a name (e.g. "Scout CLI").</li>
                <li>Copy the <strong>Supabase Access Token</strong> (starts with <code>sbp_</code>) into the Scratchpad.</li>
              </ol>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-zinc-500 mt-1 mb-2">Used to evaluate issues. Click "Create API Key" in the Groq console.</p>
                </div>
                <div>
                  ...
                  <div className="text-xs text-zinc-500 mt-1">
                    <ol className="list-decimal pl-4 space-y-1 mt-1 mb-2">
                      ...
                      <li>Under <strong>Permissions</strong>, click <strong>+ Add permissions</strong>. Find <strong>Issues</strong> and <strong>Pull Requests</strong> and set them both to <strong>Read and Write</strong>.</li>
                    </ol>
                    <p className="text-xs italic text-zinc-400">If your GitHub token ever expires, simply generate a new one and run the CLI setup again.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-zinc-900 border border-zinc-800 p-6 flex gap-4 text-white shadow-md rounded-lg">
            ...
            <div className="w-full">
              ...
              <p className="text-sm text-zinc-400 mt-1 mb-4">Run this command in your terminal. It will prompt you for the keys you collected in the scratchpad, securely inject them into your Supabase Vault, and deploy the Edge Functions.</p>
          ...
          <div className="bg-white border border-zinc-200 p-6 flex gap-4 shadow-sm rounded-lg hover:border-emerald-200 transition-colors">
            ...
            <div className="w-full flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div>
                <h3 className="text-lg font-bold text-zinc-900">5. Ready to Go!</h3>
