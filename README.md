...
2. In your Supabase Dashboard, go to **Authentication > URL Configuration**:
   - Set the **Site URL** exactly to the URL where you deployed the frontend (e.g. `https://<your-username>.github.io/Open_Source_Scout`)
   - Add the exact URL with a wildcard to the **Redirect URLs** (e.g. `https://<your-username>.github.io/Open_Source_Scout/*`)
