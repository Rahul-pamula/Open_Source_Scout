...
6. **The user flow / happy path** — scan beyond marketing pages. The brag's strongest material is usually the product _in use_, not the product's marketing of itself. Look at:
   ...
   Identify the 2–3 beats of _using_ the product: **entry → key action → result.**
