...
[The 2–3 beats of _using_ the product (entry → key action → result), pulled from
...
- "16:9 → 9:16 transform diagram" — that's a _diagram of what the product does_, not the product doing it.
